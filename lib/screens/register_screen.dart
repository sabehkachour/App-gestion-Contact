...
class _RegisterScreenState extends State<RegisterScreen> {
            ...
            child: Column(
              ...
              children: [
                IconButton(
                  ...
                  icon: Icon(Icons.arrow_back_ios_new_rounded, color: Colors.teal[700]),
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Icon(Icons.person_add_alt_1_rounded, size: 40, color: Colors.teal[700]),
                      ),
                      SizedBox(height: 20),
                      Text(
                        "Créer un compte",
                      ...
                      SizedBox(height: 8),
                      Text("Rejoignez notre communauté", style: TextStyle(fontSize: 16, color: Colors.grey[600])),
                    ],
                  ),
                ),
                  ...
                  child: Column(
                    children: [
                      _buildFormField(
                        ...
                        validator: (value) {
                          if (value == null || value.isEmpty) return "Le nom d'utilisateur est obligatoire";
                      ...
                      _buildPasswordField(controller: passwordCtrl, label: "Mot de passe", hint: "Au moins 4 caractères", isConfirm: false),
                      SizedBox(height: 20),

                      _buildPasswordField(controller: confirmPasswordCtrl, label: "Confirmer le mot de passe", hint: "Répétez votre mot de passe", isConfirm: true),
                      SizedBox(height: 30),
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Text("Vos données sont sécurisées et confidentielles", style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                      SizedBox(height: 4),
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 4),
                          Text("Protection des données", style: TextStyle(color: Colors.grey[400], fontSize: 10)),
                        ],
                      ),
                    ],
                  ),
  ...
  Widget _buildFormField({
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: TextStyle(fontWeight: FontWeight.w600, color: Colors.grey[800], fontSize: 14)),
        SizedBox(height: 8),
        Container(
          decoration: BoxDecoration(
        ...
        Container(
          ...
          child: TextFormField(
            ...
            validator: (value) {
              ...
              if (isConfirm && value != passwordCtrl.text) return "Les mots de passe ne correspondent pas";
              return null;
            },
            decoration: InputDecoration(
              hintText: hint,
